...
run() {
    ...
    echo "============================================================"
    echo "FILE: $file"
    echo "CMD : ./bin/dragonstone.sh run ./bootstrap/bin/main.ds build-run --target c --output ./bin/dev/bootstrap/build $file"
    ./bin/dragonstone.sh run ./bootstrap/bin/main.ds build-run --target c --output ./bin/dev/bootstrap/build "$file"
}
