...
Examples:
  ...
  run_benchmarks.sh --program bin/scripts/benchmark/1b.ds --program bin/scripts/benchmark/1m.ds
EOF
}
...
if [[ ${#programs[@]} -eq 0 ]]; then
    default_programs=(
        bin/scripts/benchmark/1b.ds
        bin/scripts/benchmark/1b_nested.ds
        bin/scripts/benchmark/1m.ds
        bin/scripts/benchmark/1m_nested.ds
    )
