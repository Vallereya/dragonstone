...
/* Current working directory.
    * The resolver canonicalizes relative module paths against this, so it has to
    * come from the ABI rather than the host runtime. DS_GETCWD is already mapped
    * to _getcwd/getcwd above.
*/
