...
`e! is similar to echo as it prints the value to the standard output, but it also prints the expression in code. It's a useful tool for inspecting its state and debugging.`
